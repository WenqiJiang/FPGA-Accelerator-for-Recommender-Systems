...
tf.compat.v1.app.flags.DEFINE_string("checkpoint_path", "", "Checkpoint file path")
tf.compat.v1.app.flags.DEFINE_string("tensor_name", "", "Name of the tensor to inspect")
