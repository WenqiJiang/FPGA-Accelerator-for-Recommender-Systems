...
def _wide_deep_combined_model_fn(
    ...
    input_layer_partitioner = input_layer_partitioner or (
        tf.compat.v1.min_max_variable_partitioner(max_partitions=num_ps_replicas,
    ...
    if model_type == 'wide' or not dnn_feature_columns:
        ...
        dnn_partitioner = tf.compat.v1.min_max_variable_partitioner(max_partitions=num_ps_replicas)
    ...
    if not with_cnn:
        ...
        with tf.compat.v1.variable_scope(
            ...
            cnn_logits = tf.compat.v1.layers.dense(
                img_vec,
                units=head.logits_dimension,
    ...
    def _train_op_fn(loss):
        ...
        with tf.control_dependencies([train_op]):
            ...
            with tf.compat.v1.colocate_with(global_step):
