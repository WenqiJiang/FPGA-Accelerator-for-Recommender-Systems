...
tf.compat.v1.app.flags.DEFINE_string('model_type', CONF['model_type'],
                           """Model type to export""")
tf.compat.v1.app.flags.DEFINE_string('checkpoint_path', CONF['checkpoint_path'],
                           """Directory to read training checkpoints. If None, use latest.""")
tf.compat.v1.app.flags.DEFINE_string('export_dir', CONF['model_dir'],
                           """Directory to export inference model.""")
tf.compat.v1.app.flags.DEFINE_integer('model_version', CONF['model_version'], 'version number of the model.')
